...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@ubiquitous_tech_rules_kustomize//kustomize:toolchain_type"]
    return [
        toolchain_info,
...
toolchain(
    ...
    toolchain_type = "@ubiquitous_tech_rules_kustomize//kustomize:toolchain_type",
)
""".format(
            platform = platform,
